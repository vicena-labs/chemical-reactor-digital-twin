...
batch = simulate_batch(net, feed, 330, 10, volume=0.001, ua=25, coolant_temperature=330)
cstr = simulate_cstr(net, feed, 330, 10, ua_over_volume=25000, coolant_temperature=330)
pfr = simulate_pfr(net, feed, 330, 10, ua_over_volume=25000, coolant_temperature=330)
summary = {}
